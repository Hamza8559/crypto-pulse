                                ...
                                <div className="col-lg-10">
                                    <form action="">
                                        <div className={styles.headerContainer}>
                                            ...
                                            <p className={styles.subtitle}>Sign Up to continue your crypto trade</p>
                                            <EmailInput text={"Email/Phone number"} placeHolder={"Email/Phone number"} className={"mt-4"} />
                                            <Next title={"Next"} styled={{ width: "100%", marginTop: "30px" }} link={"/SignUp/VerifyEmail"} />
                                            <Divider />
                                            ...
                                            <div className={`${styles.Bottomcontainer} mt-4`}>
                                                <p className={styles.mainText}>
                                                    <b>Already using Cryptopulse?</b> <Link to={'/SignIn'} className={styles.signUpLink} >
                                                        Sign in
                                                    </Link>
